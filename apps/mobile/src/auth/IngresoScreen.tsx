...
//
// F-5 (2026-09-24 review): moved here from `app/ingreso.tsx`, which is now a
// thin route — `app/` sits outside jest's `roots`, so this was the last
// full-screen form in the app that could not be render-tested.
