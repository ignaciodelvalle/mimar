...
export { default } from "@/app/gob/reglas/[country]/[province]/[locality]/editar/[ruleId]/page";
export { dynamic } from "@/app/gob/reglas/[country]/[province]/[locality]/editar/[ruleId]/page";
